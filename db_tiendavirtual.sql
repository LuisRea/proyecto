...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-01-2021 a las 00:30:37
...
--
ALTER TABLE `cargo`
  MODIFY `idcargo` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `permisos`
  MODIFY `idpermisos` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `permisos`
  ADD CONSTRAINT `permisos_ibfk_1` FOREIGN KEY (`cargoid`) REFERENCES `cargo` (`idcargo`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `persona`
  ADD CONSTRAINT `persona_ibfk_1` FOREIGN KEY (`cargoid`) REFERENCES `cargo` (`idcargo`) ON DELETE CASCADE ON UPDATE CASCADE;
